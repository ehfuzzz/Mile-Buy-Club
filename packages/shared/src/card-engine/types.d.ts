export type CreditFrequencyUnit = 'MONTHLY' | 'QUARTERLY' | 'SEMIANNUAL' | 'ANNUAL' | 'EVERY_N_YEARS';
...
export interface CardCredit {
    creditId: string;
    title: string;
    type: 'GENERIC_TRAVEL' | 'AIRLINE_INCIDENTAL' | 'HOTEL_PORTAL_BOOKING' | 'HOTEL_ANY' | 'RIDESHARE_MONTHLY' | 'DINING_MONTHLY' | 'TRUSTED_TRAVELER_CREDIT' | 'PORTAL_TRAVEL_CREDIT' | 'MERCHANT_SPECIFIC' | 'ANNIVERSARY_POINTS' | string;
    amount: CreditAmount;
