...
exports.AVERAGE_REDEMPTION_VALUES = exports.TRANSFER_PARTNERS = void 0;
exports.getTransferPartner = getTransferPartner;
exports.getTransferPartnersFrom = getTransferPartnersFrom;
exports.getTransferPartnersTo = getTransferPartnersTo;
exports.canTransferDirect = canTransferDirect;
exports.findTransferPaths = findTransferPaths;
exports.calculateEffectiveRatio = calculateEffectiveRatio;
exports.estimateTransferTime = estimateTransferTime;
exports.getAverageRedemptionValue = getAverageRedemptionValue;
/**
 * Comprehensive transfer partner relationships
 * Format: from_to with underscore separator
 */
exports.TRANSFER_PARTNERS = {
    // ============================================================================
 ...
 */
function getTransferPartner(from, to) {
    const key = `${from}_${to}`;
    return exports.TRANSFER_PARTNERS[key] || null;
}
/**
 * Get all transfer partners for a source program
 */
function getTransferPartnersFrom(from) {
    return Object.values(exports.TRANSFER_PARTNERS).filter(tp => tp.from === from);
}
/**
 * Get all programs that can transfer to a destination
 */
function getTransferPartnersTo(to) {
    return Object.values(exports.TRANSFER_PARTNERS).filter(tp => tp.to === to);
}
/**
 * Check if direct transfer is possible
 */
function canTransferDirect(from, to) {
 ...
 */
function findTransferPaths(from, to, maxHops = 2) {
    const paths = [];
    // Direct transfer
 ...
 */
exports.AVERAGE_REDEMPTION_VALUES = {
    // Airlines
    AA: 1.4,
    DELTA: 1.2,
    UNITED: 1.3,
 ...
 */
function getAverageRedemptionValue(program) {
    return exports.AVERAGE_REDEMPTION_VALUES[program] || 1.0;
}
//# sourceMappingURL=transfer-partners.js.map